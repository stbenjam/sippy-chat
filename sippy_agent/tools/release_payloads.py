...
class SippyReleasePayloadTool(SippyBaseTool):
    ...
    description: str = "Get OpenShift release payload information. When asked for 'latest' or 'last' payload, returns the most recent payload's name and status. Input: release version (e.g., '4.20') and optional stream type ('nightly' or 'ci', defaults to 'nightly')"
